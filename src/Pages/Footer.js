...
const Footer = () => {
  ...
  <div class="flex space-x-4">
    ...
    <a href="https://wa.me/0094757099055" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center w-8 h-8 rounded-md border border-white hover:bg-white hover:text-black transition-colors duration-300">
